...
function openGameStory(){
  ...
  openSimpleModal(
    ...
    `
      <p>
        Колись КіберКоролівство захищали П'ять Кристалів.
        Вони берегли знання, уважність, правду, особисті дані
        та безпеку всіх мешканців.
      </p>

      <p>
        Але Мордер накрив Королівство цифровою грозою
        та викрав Райфіка — вірного охоронця королівської брами.
      </p>

      <p>
        Щоб врятувати Райфіка, герой має пройти п'ять локацій:
      </p>
      ...
      <ul>
        ...
        <li>Озеро Фейків</li>
        <li>Печеру Даних</li>
        <li>Фортецю Захисту</li>
      </ul>

      <p>
        У кожній локації наставник допоможе отримати артефакт
        і зарядити один із Кристалів.
      </p>

      <p>
        Лише коли всі П'ять Кристалів засяють,
        відкриється шлях до Цитаделі Хаосу.
      </p>
    `
  );
  ...
  openSimpleModal(
    ...
    `
      ...
      <ul>
        ...
        <li>озвучку наставників;</li>
        <li>підказки для гравця.</li>
      </ul>
    `
  );
